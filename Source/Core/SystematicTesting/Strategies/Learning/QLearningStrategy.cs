...
namespace Microsoft.Coyote.SystematicTesting.Strategies
{
    ...
    internal sealed class QLearningStrategy : RandomStrategy
    {
        ...
        /// </summary>
        private readonly string AbstractionLevel;
        ...
        /// <summary>
        /// The set of custom only hashed states.
        /// </summary>
        /// // [Arun:]  CustomOnlyHashedStates instead of FullHashedStates.
        private readonly HashSet<int> CustomOnlyHashedStates;
            ...
            : base(maxSteps, random)
        {
            ...
            this.CustomOnlyHashedStates = new HashSet<int>(); // [Arun: ] replacement for FullHashedStates
            ...
            Console.Out.WriteLine("AbstractionLevel: " + this.AbstractionLevel);
        }
        ...
        private int CaptureExecutionStep(AsyncOperation current)
        {
            ...
            {
                case "custom-only":
                    state = current.CustomOnlyHashedState; // [Arun: ] instead of FullHashedState
                    break;
            ...
            this.CustomOnlyHashedStates.Add(current.CustomOnlyHashedState); // [Arun: ] instead of Full hased state
