...
{
    public class FailureDetector : BaseActorSystematicTest
    {
        public FailureDetector(ITestOutputHelper output)
            : base(output)
        {
        }
        ...
        public void TestBugInFD()
        {
            ...
            this.Test(r =>
            {
                ...
                r.CreateActor(typeof(ClusterManager), new ClusterManager.Config(2));
            },
            ...
            configuration: configuration,
            expectedError: "Violation in safety monitor.",
            replay: true); */
        }
    }
}
